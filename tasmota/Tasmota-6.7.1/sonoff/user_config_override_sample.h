...
#undef  STA_SSID1
#define STA_SSID1         "SARAH"             // [Ssid1] Wifi SSID

#undef  STA_PASS1
#define STA_PASS1         "sarah"     // [Password1] Wifi password

// -- Setup your own MQTT settings  ---------------
#undef  MQTT_HOST
#define MQTT_HOST         "192.168.0.7" // [MqttHost]
...
#ifdef MY_GW
#undef  WIFI_GATEWAY
#define WIFI_GATEWAY      "192.168.0.1"                  // if not using DHCP set Gateway IP address
#endif

#ifdef MY_DNS
#undef  WIFI_DNS
#define WIFI_DNS          "192.168.0.1"                 // If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)
#endif
